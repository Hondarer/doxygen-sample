...
- [ ] GitHub アカウントを作成し、リポジトリをフォーク・クローンできます。
- [ ] feature ブランチを作成し、変更をプッシュできます。
- [ ] Pull Request を作成し、説明を記述できます。
- [ ] PR のレビュー コメントに応答し、変更を追加できます。
- [ ] Issues を作成し、PR とリンクできます。
- [ ] GitHub Flow (feature branch → PR → review → merge) を説明できます。
- [ ] PR がマージされたときに CI が実行されることを確認できます。
