...
- [ ] GitHub Pages の仕組み (静的サイト ホスティング) を説明できます。
- [ ] GitHub リポジトリの Pages 設定を確認・変更できます。
- [ ] `gh-pages` ブランチまたは `docs/` フォルダーからの公開設定を理解できます。
- [ ] `peaceiris/actions-gh-pages` Action の基本的な使い方を理解できます。
- [ ] 公開された Pages の URL を確認できます。
- [ ] デプロイに失敗した場合の基本的なトラブルシューティングができます。
