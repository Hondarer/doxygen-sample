...
int main(int argc, char *argv[])
{
    ...
    int arg1 = 0;
    int arg2 = 0;
    com_util_argparser_default_init("2 つの整数を加算します。");
    com_util_argparser_default_register_flag("-h", "--help", "ヘルプを表示します。", &need_help);
    com_util_argparser_default_register_positional_int("arg1", "第一オペランド。", COM_UTIL_ARGPARSER_REQUIRED, &arg1);
    com_util_argparser_default_register_positional_int("arg2", "第二オペランド。", COM_UTIL_ARGPARSER_REQUIRED, &arg2);
